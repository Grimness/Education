...
.btn.disabled{cursor:not-allowed;background-image:none;opacity:.65;filter:alpha(opacity=65);box-shadow:none; pointer-events:none;} 
  ...
  <body onload="msg()">
     <form id="form1" name="form1" method="post" action="add_tx_fin.do" >


<center>
题型名称：<input type="text" name="Fname" id="Fname"><br/>
...
<input class="btn btn-primary radius" type="submit" value="添加" >
 <input class="btn btn-primary radius" type="button" value="取消"  onclick="javascript:window.close();" >
</center>
