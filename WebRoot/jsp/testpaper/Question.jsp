  		...
  		<tr style="height:50px;">
  			...
  			<td>
  				...
  				<!-- 
  					...
  					<div style="float:right;margin:0 1%;"><input style="height:28px;" type="button" value="修改" onclick="javascript:window.location.href='ex_alter.do?fid=${getex.fid}&exfid=${getex.exfid}&FExamID=${getex.FExamID}'"></div>
  				</div>
  			</td>
  		</tr>
  		<%i++; %>
