...
<html>
  ...
  document.forms.example.enctype="multipart/form-data";
    ...
    function alert(){
  document.forms.example.action="ex_alert_fin.do";
...
document.forms.example.enctype="";
  ...
  <input type="text" name="fsubjectid" id="fsubjectid" value="${ex.fsubjectid}" style="display:none">
   ...
   <input type="text" name="funit" id="funit" value="${ex.funit}" style="display:none">
     ...
     <input type="text" name="exfid" id="exfid" value="${ex.exfid}" style="display:none">
     <input type="text" name="FExamID" id="FExamID" value="${ex.FExamID}" style="display:none">
	<div style="width:100%;">
		<div style="float:left;width:80%;padding-top:2%;">
			...
			<tr>
				...
				<tr style="display:none">
					...
					<td><input type="text" style="width:40%;" name="FTitle4" id="FTitle4" value="${ex.FTitle4 }"></td>
				</tr>
				...
				<tr>
				<td ><input type="file"   id="FAudioFileName" name="FAudioFileName" style="background:#FFFFFF;"><input type="button" style="background:#F2F2F2;" value="上传" onclick="music()"></td><td><iframe id="success" name="success" style="width:20%;height:15%; display:none"></iframe></td>
				...
				<tr <c:if test="${ex.fsubjectid!='YY'}" >style="display:none"</c:if>>
					...
					<td ><input type="file"   id="FYYAudioFileName" name="FYYAudioFileName" style="background:#FFFFFF;" ><input type="button" style="background:#F2F2F2;" value="上传" onclick="yymusic()"></td>
				</tr>
				<tr <c:if test="${ex.fsubjectid!='YY'}" >style="display:none"</c:if>>
					<td colspan=2>标签</td>
