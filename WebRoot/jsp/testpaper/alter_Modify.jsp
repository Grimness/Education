...
var ExamID=document.getElementsByName('FExamID');
	FExamID=ExamID.FExamID.value;
	//alert(FExamID);
	window.self.TL.location.href="${pageContext.request.contextPath }/check_tx.do?FExamID="+FExamID;
...
var fname=document.getElementsByName('fname');
 ...
 function check()
  ...
  <body onload="txcheck()">
  <form id="form1" name="form1" method="post" action="alter_examination_fin.do" onsubmit="return check();">
  <input type="text" name="FExamID" id="FExamID" value="${altexa.FExamID}" style="display:none">
  	<table border="1" style="width:100%;border-collapse:collapse;">
  		...
  		<tr>
  			<td colspan="2">
  				<div>
					...
					<div style="float:left;">试卷名称：<input style="width:200px;" id="fname" name="fname" type="text" value="${altexa.fname}"></div>
					<div style="float:left;margin-left:5%; ">描述：<input id="FDESC" name="FDESC" type="text" value="${altexa.FDESC}"></div>
  				</div>
  				</br>
  				<div>
  				<div style="float:right;margin:0 1%;"><input style="height:28px;" id="s" name="s" type="button" value="返回" onclick="javascript:window.location.href='settestpaper.do';"></div>
  					<div style="float:right;margin:0 1%;"><input style="height:28px;" id="p" name="p" type="button" value="预览试卷" onclick="preview()"></div>
  					<div style="float:right;margin:0 1%;"><input style="height:28px;" id="s" name="s" type="submit" value="修改试卷" ></div>
  		...
  		<tr>
  			...
  			<td style="width:60%"><iframe src="Question.do?FExamID=${altexa.FExamID}&exfid=0" name="Q" id="Q" frameborder="0" name="Q" style="width:100%;height:400px;"></iframe></td>
  		</tr>
  	</table>
  	</form>
  </body>
