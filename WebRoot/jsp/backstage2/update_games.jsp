...
<script type="text/javascript">
  ...
  document.forms.example.action="updae_Games.do";
...
<style type="text/css">
  ...
  padding-right: 14px;
   ...
   <input type="text" name="funit" id="funit" value="${ex.funit}" style="display:none">
    ...
    <input type="text" name="Faudio" id="Faudio" value="${ex.faudio}" style="display:none">
    <input type="text" name="fid" id="fid" value="${ex.fid}" style="display:none">
   	<div style="width:100%;">
			...
			<tr>
			<td><input type="text" id="number" name="number" value="${ex.number }"></td>
			</tr>
			<tr>
			<td>标题</td>
			</tr>
			<tr>
			<td><input type="text" id="Ftitle" name="Ftitle" value="${ex.ftitle }"></td>
			</tr>
			<tr>
			<td>图片</td>
			</tr>
			<tr>
			<td><textarea name="Fimg" id="Fimg" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${ex.fimg }</textarea></td>
			</tr>
			<tr>
			<td>答案</td>
			</tr>
			<tr>
			<td><input type="text" id="Fanswer" name="Fanswer" value="${ex.fanswer }"></td>
			</tr>
			<tr>
			<td>音频文件</td>
			</tr>
			<tr>
			<td ><input type="file"   id="Faudio1" name="Faudio1" style="background:#FFFFFF;"><input type="button" style="background:#F2F2F2;" value="上传" onclick="music()"><br/>
			...
			<tr>
			<td><textarea name="Fdiscuss" id="Fdiscuss" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${ex.fdiscuss }</textarea></td>
			</tr>
			<tr >
					<td >
					<br/>
