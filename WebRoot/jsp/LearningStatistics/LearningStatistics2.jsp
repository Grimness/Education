...
<body style="background:#EAEAEA;">
	<table border="0" style="border-collapse:collapse;width:100%;background:#FFFFFF;">
		<tr>
			<td style="text-align:center;"><a href="#" style="color:blue;">三年级1班</a></td>
			<td style="text-align:center;"><a href="#" >三年级2班</a></td>
			<td style="text-align:center;"><a href="#" >四年级1班</a></td>
		</tr>
	</table>
	<table border="0" style="border-collapse:collapse;width:100%;margin :2% 0;background:#FFFFFF;" >
		...
		<tr style="height:30px;">
			<td colspan="2">
			<div >
				<div style="float:right;padding-right:2%;"><input style="color:#FFFFFF;background:blue;" type="button" value="分析报告"></div>
				<div style="float:right;padding-right:2%;"><input style="color:#FFFFFF;background:red;" type="button" value="强化练习"></div>
			</div>
			</td>
		</tr>
	</table>
