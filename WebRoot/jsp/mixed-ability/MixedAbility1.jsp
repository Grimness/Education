		...
		<tr>
			<td colspan="2" style="text-align:center;padding-top: 2%">
				<select onchange="window.location=this.value;">
					<option>实践活动</option>
					<option value="<%=basePath%>ElectronicArchives1.do?FStudentID=${FStudentID}&FPhone=${FPhone}">电子档案</option>
				</select>
			</td>
		</tr>
		<tr>
	...
	<article>
		...
		<c:if test="${practice.ftype==1&&practice.fsex==0}"><!-- 判断头像 -->
			...
			<aside >
				...
				<div id="element_id" > 
				<a  title="文字说明"    href="<%=basePath%>upload/${practice.FPhoto1}"><img src="<%=basePath%>upload/${practice.FPhoto1}" width="80px" height="69px"></a>
				</div>
				</c:if>
