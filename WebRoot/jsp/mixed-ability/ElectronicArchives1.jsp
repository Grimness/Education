...
<script type="text/javascript">
		...
		function eRecordDetail(id){
			var ferid = id;
			window.location.href="<%=basePath%>ElectronicArchivesDetails1.do?ferid="+ferid;
		}	
		function select(){
		...
		<tr>
			<td colspan="2" style="text-align:center;padding-top: 2%">
				<select id="select" onchange="select()">
					<option  value="ElectronicArchives1.do">电子档案</option>
					<option value="MixedAbility1.do">实践活动</option>
				</select>
			</td>
		</tr>
		<tr>
